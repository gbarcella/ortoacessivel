...
<div class="box box-primary" style="padding: 10px;">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <form action="/search-chamado-usuario-admin-aberto" method="get">
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('destroy-chamado', $c->id)}}" method="POST">
                            ...
                            <a class="btn btn-primary" href="{{ route('edit-chamado-aberto',$c->id) }}"><i class="fa fa-edit"></i></a> 
